...
$('#stepHelpButton7').click(function () {
    ...
    if ($('#stepHelpButton7').attr('name') == "status 2") {
        ...
        if (data[index_number].Gradation == "none") {
            ...
            $('#stepExplanation7').show();
            $('#stepExplanation7').html("Ok, so we have the stem and the stem + ending:<br/><div class='ui compact message'><span class='ui large text'>" + $('#stepAnswer4').html() + "</span></div> <div class='ui compact message'><span class='ui large text'>*" + $('#stepAnswer4').html().slice(0, -1) + $('#stepAnswer6').html().slice(1) + "</span></div><br/><br/>We cut them into syllables:<br/><div class='ui compact message'><span class='ui large text'>" + data[index_number].StemCut + "</span></div> <div class='ui compact message'><span class='ui large text'>*" + data[index_number].BeforeGradationCut + "</span></div><br/><br/>Then we look at the last syllable from the stem:<br/><div class='ui compact message'><span class='ui large text'>" + data[index_number].StemCutUnderlined + "</span></div> <div class='ui compact message'><span class='ui large text'>" + data[index_number].BeforeGradationCutUnderlined + "</span></div><br/><br/>We compare how they look:<br/><div class='ui compact message'><span class='ui large text'>" + data[index_number].StemSyllable + "</span></div> <div class='ui compact message'><span class='ui large text'>" + data[index_number].BeforeGradationSyllable + "</span></div><br/><br/>The first one is <b>" + data[index_number].StemSyllableStatus + "</b> and the second one is <b>" + data[index_number].BeforeGradationSyllableStatus + "</b>.<br/><br/>So from <b>Stem > Word</b> the syllable goes<br/><div class='ui compact message'><span class='ui large text'>" + data[index_number].StemSyllableStatus + "</span></div> → <div class='ui compact message'><span class='ui large text'>" + data[index_number].BeforeGradationSyllableStatus + "</span></div><br/><br/>The consonant(s) right before that syllable is <b>" + data[index_number].ConsonantBefore + "</b> and it needs to also change from <i>" + data[index_number].StemSyllableStatus + " > " + data[index_number].BeforeGradationSyllableStatus + "</i><br/><br/>In the table you can see that a <b>" + data[index_number].ConsonantBefore + "</b> in an <i>" + data[index_number].StemSyllableStatus + " syllable</i> corresponds to a <b>" + data[index_number].ConsonantAfter + "</b> in a <i>" + data[index_number].BeforeGradationSyllableStatus + " syllable</i><br/><br/>So in this case you need to apply <br/><div class='ui compact message'><span class='ui large text'>" + data[index_number].ConsonantBefore + "</span></div> → <div class='ui compact message'><span class='ui large text'>" + data[index_number].ConsonantAfter + "</span></div>");

            //            <br/><br/>So from Stem > Word the syllable goes <i>" + data[index_number].StemSyllableStatus + " > " + data[index_number].BeforeGradationSyllableStatus + "</i><br/><br/>The consonant(s) right before that syllable is <b>" + data[index_number].ConsonantBefore + "</b> and it needs to also change from <i>" + data[index_number].StemSyllableStatus + " > " + data[index_number].BeforeGradationSyllableStatus + "</i><br/><br/>In the table you can see that a <b>" + data[index_number].ConsonantBefore + "</b> in an <i>" + data[index_number].StemSyllableStatus + " syllable</i> corresponds to a <b>" + data[index_number].ConsonantAfter + "</b> in a <i>" + data[index_number].BeforeGradationSyllableStatus + " syllable</i><br/><br/>So in this case you need to apply <b>" + data[index_number].Gradation + "</b>");
            $('#stepHelpButton7').hide();
